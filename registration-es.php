  ...
  <div class="registration-container registration-extended">
    <div class="registration-box animated fadeInDown">
      ...
      <div class="registration-body">
        <div class="row">
          <div class="col-md-6">
            <div align="center"><h1 style="color:#fff;">CREAR CUENTA</h1></div>
            <div class="registration-subtitle" align="justify" style="border-bottom: 1px dashed #F39C12; padding-bottom:15px;">¡Bienvenido a RADIO FM! Asegúrese de tener su información correcta para ser reconocido por su talento.</div>
            ...
            <div id="slform_1" style="padding-bottom:0px;">
              <form id="form-register" action="" method="post">
                ...
                <?php if (function_exists('registeruser')) registeruser("RADIONER","0","/thanks-es.php","newuser.htm","newuseradmin.htm","Yes","YYYYYNNNNYNNNYNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN","1"); ?>

                <h4 style="color:#F39C12;">Información Personal</h4>
                <div id="slfielddiv_1_0" class="sltextfield_1">
                  <input type="text" class="form-control" name="regname" id="slfieldinput_1_0" autocorrect="off" autocapitalize="off" spellcheck="off" autocomplete="off" maxlength="100" value="<?php echo $regname; ?>" placeholder="Nombre Legal">
                  <div id="slmsg_1_0" class ="slmsg_1" aria-live="polite" style="color:#C0392B;"></div>
                </div><br>

                <div id="slfielddiv_1_1" class="sltextfield_1">
                  <input type="email" class="form-control" name="regemail" id="slfieldinput_1_1" autocorrect="off" autocapitalize="off" spellcheck="off" autocomplete="off" maxlength="100" value="<?php echo $regemail; ?>" placeholder="Correo Electrónico">
                  <div id="slmsg_1_1" class ="slmsg_1" aria-live="polite" style="color:#C0392B;"></div>
                </div><br>

                <div id="slfielddiv_1_2" class="sltextfield_1">
                  <input type="text" class="form-control" name="regusername" id="slfieldinput_1_2" autocorrect="off" autocapitalize="off" spellcheck="off" autocomplete="off" maxlength="100" value="<?php echo $regusername; ?>" placeholder="Nombre de usuario">
                  <div id="slmsg_1_2" class ="slmsg_1" aria-live="polite" style="color:#C0392B;"></div>
                </div><br>

                <div id="slfielddiv_1_3" class="sltextfield_1">
                  <input type="password" class="form-control" name="regpassword" id="slfieldinput_1_3" autocorrect="off" autocapitalize="off" spellcheck="off" autocomplete="off" placeholder="Contraseña">
                ...
                <div class="row">
                  <div class="col-md-6" style="margin-left:-10px;">
                    <div id="slfielddiv_1_4" class="sltextfield_1">
                      <div class="registration-subtitle" style="color:#7B7D7D;"><small>Código del País <a href="#" title="ISO-3166-1: Alpha-2"><i class="far fa-exclamation-circle"></i></a></small></div>
                      <select name="custom1" id="slfieldinput_1_4" class="form-control">
                        <option value="None" selected>Seleccione su país</option>
                        <?php
                  ...
                  <div class="col-md-6" style="padding:0px; right:0; position:absolute; margin-right:10px;">
                    <div id="slfielddiv_1_5" class="slselectfield_1">
                      <div class="registration-subtitle" style="color:#7B7D7D;"><small>- Seleccione una opción</small></div>
                      <select name="custom10" class="form-control" id="slfieldinput_1_5">
                        <option value="">Select One</option>
                        <option style="background-color:#555;" value="Crypto Enthusiast" <?php if ($custom10=="Crypto Enthusiast") echo "selected=selected"; ?>>Crypto Entusiasta</option>
                        <option style="background-color:#555;" value="Crypto Investor" <?php if ($custom10=="Crypto Investor") echo "selected=selected"; ?>>Crypto Inversor</option>
                        <option style="background-color:#555;" value="Music Lover" <?php if ($custom10=="Music Lover") echo "selected=selected"; ?>>Amante de la Musica</option>
                        <option style="background-color:#555;" value="Musician" <?php if ($custom10=="Musician") echo "selected=selected"; ?>>Musico</option>
                        <option style="background-color:#555;" value="Music Producer" <?php if ($custom10=="Music Producer") echo "selected=selected"; ?>>Productor de musica</option>
                        <option style="background-color:#555;" value="Artist Manager" <?php if ($custom10=="Artist Manager") echo "selected=selected"; ?>>Manager de artistas</option>
                        <option style="background-color:#555;" value="Audio Engineer" <?php if ($custom10=="Audio Engineer") echo "selected=selected"; ?>>Ingeniero de audio</option>
                        <option style="background-color:#555;" value="Indie Label" <?php if ($custom10=="Indie Label") echo "selected=selected"; ?>>Sello discográfico</option>
                        <option style="background-color:#555;" value="Music Publisher" <?php if ($custom10=="Music Publisher") echo "selected=selected"; ?>>Editorial de Musica</option>
                        ...
                        <option style="background-color:#555;" value="Tezos Supporter" <?php if ($custom10=="Tezos Supporter") echo "selected=selected"; ?>>Seguidor de Tezos</option>
                        <option style="background-color:#555;" value="RADIONER" <?php if ($custom10=="RADIONER") echo "selected=selected"; ?>>RADIONER</option>
                        <option style="background-color:#555;" value="None of the above" <?php if ($custom10=="None of the above") echo "selected=selected"; ?>>Ninguna de las anteriores</option>
                      </select>
                ...
                <div class="sltextfield_1" id="slfakenamediv_1">
                  <label for="slfakename_1">No necesita llenar esta información</label>
                ...
                <button type="button" id="wallet-btn" class="button btn" disabled><i class="fad fa-arrow-alt-to-right"></i> Continuar</button><br>
              </form>
            </div>
          </div>

          <div class="col-md-6 wallet-side">
            <div class="registration-title" style="color:#7B7D7D;"><i class="far fa-plus-circle"></i> <strong>Billetera</strong> para Tezos Blockchain.</div>
            <div class="registration-subtitle" style="border-bottom: 1px dashed; color:#7B7D7D; padding-bottom:15px;" align="justify">Para usar nuestra plataforma usted necesita una billetera que funcione con Tezos. Si no tiene una, podemos ayudarlo/a a crear una billetera nativa para usted.</div>

            <div class="form-horizontal">
              <div class="user-wallet" style="display: none;">

                <h4 style="color:#F39C12;">Billetera Personal</h4>
                <p align="justify" class="registration-subtitle">Si eres nuevo en el tema de las cryptomonedas y no estás completamente seguro qué es una billetera crypto, le recomendamos crear una billetera nativa en nuestro sistema para familiarizarse con conceptos básicos. Esta parte del proceso es esencial, pues sin ella no puede ocupar la plataforma y beneficiarse de sus servicios.</p>

				<p align="justify" class="registration-subtitle">Ahora, si sigue confundido y prefieres aprender de manera visual ¡te recomendamos que veas este video! <a href="https://www.youtube.com/watch?v=9rMDgFsA7wo" target='blank' rel='nofollow'>Click Aquí</a>.</p>
				<br>
				<button type="button" class="create-wallet btn btn-deafult btn-block"><i class="fad fa-wallet fa-lg"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CREAR BILLETERA NATIVA</button>
                <button type="button" class="import-wallet btn btn-primary btn-block"><i class="far fa-wallet fa-lg"></i>&nbsp;&nbsp;CONECTAR BILLETERA</button><br>
                <p align="justify" class="registration-subtitle"><strong>Nota</strong>: Usamos un SDK de terceros para interactuar con el protocolo de Tezos.</p>
              </div>

              <form id="create-wallet-form" action="#" method="get">
                <div class="create-wallet-form-words" style="display:none;">
                  <h4>Bien, vamos a crear tu billetera nativa!</h4>
                  ...
                  <p class="registration-subtitle" align="justify">Si es nuevo en el espacio criptográfico, es muy probable que no esté familiarizado con algunos términos, por ejemplo; "Palabras Iniciales". Las palabras iniciales son la llave maestra de su billetera. Asegúrese de escribir las palabras en un papel y guárdelo en un lugar seguro. Lo necesitará para tener acceso y administrar los fondos de su billetera.</p>
                  <div align="center">
                    <h4>--- PALABRAS INICIALES ---</h4>
                  </div>

                  <span class="create-wallet-words" style="color:#2E86C1;"></span><hr>
                  <button type="button" class="create-wallet-words-proceed button btn btn-default"><i class="fad fa-arrow-alt-to-right"></i> Siguiente</button>
                </div>

                <div class="create-wallet-verify" style="display:none;">
                  <h4>Vamos a verificar las palabras!</h4>
                  <p class="registration-subtitle" align="justify">Tenga en cuenta que no se trata solo de tener las palabras, sino que también debe mantener el orden en el que se le dieron. ¡Mire su copia de seguridad para verificar!<br><br> ¡Escriba la palabra que falta! <span style="padding-left:10px; padding-right:10px;">-</span> <span class="create-wallet-verify-steps" style="color:#F39C12;">0/6</span></p>
                ...
                <div class="create-wallet-complete" style="display:none;">
                  <div align="center"><br>
                    <div style="color:#fff;" align="left">Eres humano?</div><br>
                  ...
                  <div align="center">
                    <button id="myButton_1" class="button btn btn-success btn-block" type="button"><i class="fad fa-check-circle"></i> Crear Cuenta</button>
                  </div>
                </div>
              </form>
            </div>
 ...
 4.646 0 3.098-.654 5.977-1.96 8.64-1.307 2.661-3.291 4.645-5.953 5.952-2.662 1.307-5.542 1.96-8.639 1.96z"></path>
      ...
      <div class="registration-footer">
        ...
        <div class="pull-right">
          ...
          <a href="https://www.radion.fm/privacy-policy.php">Poliza de Privacidad</a> |
          <a href="https://www.radion.fm/terms-of-use.php">Terminos de uso</a>
        </div>
      </div>
    </div>
  </div>
