...
<body>
 ...
 <ul class="x-navigation x-navigation-horizontal x-navigation-panel">
     ...
     <li class="xn-icon-button pull-right">
         ...
         <ul class="xn-drop-left xn-drop animated zoomIn">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="alert alert-info" role="alert" id="message_box" style="display:none">
              ...
              <span id="aon_sibmission">RADION esta siempre activo en las redes sociales <a href="https://web.telegram.org/#/im?p=@radion_project" target="blank">Telegram</a> Group.</span>
            </div>
          </div>
        </div>
...
4.646 0 3.098-.654 5.977-1.96 8.64-1.307 2.661-3.291 4.645-5.953 5.952-2.662 1.307-5.542 1.96-8.639 1.96z"></path>
    ...
    <div style="margin-top:-10px; font-size:11px;">XTZ/USD</div>
                    ...
                    <div class="widget-buttons widget-c3">
                            ...
                            <span><a href="#modal_small" data-toggle="modal" style="font-size:13px; text-decoration:none; color:#F39C12;"><i class="fad fa-qrcode"></i> Recibe</a></span>
                            <span style="padding-right:3px; padding-left:3px;">|</span>
                ...
                <div class="panel-body">
                  <div class="row">
					...
					<form class="form-horizontal">
                                <h5 style="padding-left:3%;"><strong><i class="fas fa-vote-yea"></i> SALA DE VOTOS</strong></h5>
                                ...
                                <div class="panel panel-default tabs">
                                    <ul class="nav nav-tabs" role="tablist" style="padding-bottom:20px;" id="data_tab">
                                        ...
                                        <li id="tb2"  onclick="tab_changes(1)"><a href="#tab-second" role="tab" data-toggle="tab">Música Pop</a></li>
										<li id="tb3" onclick="tab_changes(2)" ><a href="#tab-third" role="tab" data-toggle="tab">Música Country</a></li>
										...
										<li id="tb9" onclick="tab_changes(8)"><a href="#tab-ninth" role="tab" data-toggle="tab">Música Deep</a></li>
										<li id="tb10" onclick="tab_changes(9)"><a href="#tab-tenth" role="tab" data-toggle="tab">Música Clasica</a></li>
										<li id="tb11" onclick="tab_changes(10)"><a href="#tab-eleventh" role="tab" data-toggle="tab">Electronica</a></li>
										<li id="tb12" onclick="tab_changes(11)"><a href="#tab-twelfth" role="tab" data-toggle="tab">Techno</a></li>
										<li id="tb13" onclick="tab_changes(12)"><a href="#tab-thirteenth" role="tab" data-toggle="tab">Rock Alternativo</a></li>
										<li id="tb14" onclick="tab_changes(13)"><a href="#tab-fourteenth" role="tab" data-toggle="tab">Música Casera</a></li>
										<li id="tb15" onclick="tab_changes(14)"><a href="#tab-fifteenth" role="tab" data-toggle="tab">Música Latina</a></li>
										<li id="tb16" onclick="tab_changes(15)"><a href="#tab-sixteenth" role="tab" data-toggle="tab">Romantica</a></li>
										<li id="tb17" onclick="tab_changes(16)"><a href="#tab-seventeenth" role="tab" data-toggle="tab">Relajante</a></li>
										<li id="tb18" onclick="tab_changes(17)"><a href="#tab-eighteenth" role="tab" data-toggle="tab">Música para Niños</a></li>
                    ...
                    <li id="tb21" onclick="tab_changes(20)"><a href="#tab-twentyfirst" role="tab" data-toggle="tab">Comerciales</a></li>
                                    </ul>
...
<span style="width:90%; padding-left:10px;"><a href="#" class="fas fa-briefcase"></a> SECCION DE INVERSION</span>
<div style="padding-left:10px; padding-top:10px;" >- Invercionistas: <span id="investors"><?php echo $INVEST;?></span></div>
	<div style="padding-left:10px; padding-top:10px;" >- Pagable en USD: <i class="fa fa-dollar-sign"></i> <span id="payable_amount">0</span></div>
<div style="padding-left:10px; padding-top:10px; padding-bottom:20px;" >- Pago potencial: <span id="have_to_pay_for_invest"><?php echo $INVEST_RADIO;?></span></div>
<div style="padding-left:20px;">

<table>
<tr>
<td><button class="btn btn-warning" id="sponsore_btn" onClick="notyConfirm1();"><i class="fas fa-dollar-sign"> </i> INVERTIR EN ACTIVO!</button></td>
...
<hr>
<div style="width:100%;">
<span style="width:90%; padding-left:10px;"><a href="#" class="fas fa-dollar-sign"></a> COMPRAR</span>
        ...
        <div class="sidebar">
            <div class="sidebar-wrapper scroll">
                ...
                <div class="sidebar-tabs">
                    <a href="#sidebar_1" class="sidebar-tab"><span class="fas fa-info-circle"></span> TOKEN</a>
...
<!-- END MESSAGE BOX-->
  ...
  function notyConfirm () {
    noty({
      text: 'Quiere continuar con a compra?',
      layout: 'topRight',
      buttons: [{
        addClass: 'btn btn-success btn-clean',
        text: 'Si',
...
if(have_purchase==1){
	...
	$('#download_btn').html('<button class="btn btn-default" onClick="purchaseSong()"><i class="fas fa-download"></i> DESCARGAR</button>');


	}else{

    $('#download_btn').html('<button class="btn btn-default" onClick="notyConfirm()"><i class="fas fa-download"></i> COMPRAR</button>');
...
if(result[3]!=0){
on_link='<a href='+result[3]+' target="_blank" style="text-decoration:none" rel="nofollow"> Visite auspiciador</a>';
}
 ...
 // $('.backg').css("background-image", "url("+result[4]+")");
  ...
  $('#connect-wallet').click(async function (event) {
    ...
    try {
      ...
      noty({
        text: '<i class="far fa-exclamation-circle fa-lg"></i> Coneccion fue cancelada',
        layout: 'topRight',
        type: 'error',
        timeout: 5000
      })
  ...
  async function purchaseSong () {
    ...
    try {
      ...
      noty({
        text: '<i class="far fa-exclamation-circle fa-lg"></i> Transaccion enviada. Espere confirmacion!',
        layout: 'topRight',
        type: 'information',
        timeout: 9000
      })
      ...
      if (result.completed) {
        ...
        const sweetAlert = await Swal.fire({
          ...
          title: 'SUCCESS',
          width: 450,
          html: '<br><p align="left" style="padding-left:10px;">TENEMOS CONFIRMACION!</p><hr><p align="left" style="padding-left:10px;"><strong>Transaction ID/Hash:</strong></p><p align="left" style="font-size:13px;padding-left:10px;">' + hash + '</p>',
