    ...
    var formElements = function(){                
        ...
        var feDaterangepicker = function(){
            if($(".daterange").length > 0)
               $(".daterange").daterangepicker({format: 'YYYY-MM-DD',startDate: '2018-01-01',endDate: '2019-12-31'});
        }
        // END Daterangepicker
            ...
            if($(".dateSlider").length > 0){                
                $(".dateSlider").each(function(){
                    $(this).dateRangeSlider({
                        bounds: {min: new Date(2018, 1, 1), max: new Date(2019, 12, 31)},
                        defaultValues:{min: new Date(2018, 10, 15),max: new Date(2019, 12, 15)}
                    });
                });                                                
