...
!function () {
    ...
    o.prototype = {
        ...
        play: function (e, o) {
            ...
            if (r && !a._paused)
                return o || t._loadQueue("play"), a._id;
            ...
            if (t._webAudio) {
                var m = function () {
                    ...
                    void 0 === p.bufferSource.start ? a._loop ? p.bufferSource.noteGrainOn(0, i, 86400) : p.bufferSource.noteGrainOn(0, i, d) : a._loop ? p.bufferSource.start(0, i, 86400) : p.bufferSource.start(0, i, d),
                    _ !== 1 / 0 && (t._endTimers[a._id] = setTimeout(t._ended.bind(t, a), _)),
                ...
                var v = function () {
                    ...
                    try {
                        ...
                        if (r && "undefined" != typeof Promise && (r instanceof Promise || "function" == typeof r.then) ? (t._playLock = !0, f(), r.then(function () {
                                    ...
                                    a._ended = !0,
                                    a._paused = !0
                                })) : o || (t._playLock = !1, f(), t._emit("play", a._id), t._loadQueue()), p.playbackRate = a._rate, p.paused)
                            return void t._emit("playerror", a._id, "Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction.");
                ...
                if (p.readyState >= 3 || h)
                    ...
                    var y = function () {
                        v(),
                        p.removeEventListener(n._canPlayEvent, y, !1)
                    };
        ...
        _stopFade: function (e) {
            var o = this,
            t = o._soundById(e);
            return t && t._interval && (o._webAudio && t._node.gain.cancelScheduledValues(n.ctx.currentTime), clearInterval(t._interval), t._interval = null, o.volume(t._fadeTo, e), t._fadeTo = null, o._emit("fade", e)),
            o
        },
        loop: function () {
            var e,
            ...
            if (1 === r.length) {
                ...
                2 === r.length && (e = r[0], n = parseInt(r[1], 10));
        ...
        rate: function () {
            ...
            for (var d = 0; d < o.length; d++)
                if (i = t._soundById(o[d])) {
                    ...
                    !t._endTimers[o[d]] && i._paused || (t._clearTimer(o[d]), t._endTimers[o[d]] = setTimeout(t._ended.bind(t, i), l)),
                    t._emit("rate", i._id)
                }
            return t
        },
