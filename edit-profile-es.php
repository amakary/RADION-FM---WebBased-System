...
<body>
    ...
    <div class="modal-dialog" style="width:480px;">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger cancel-btn" data-dismiss="modal">Cancelar</button>
          <button type="button" class="btn btn-primary confirm-btn" data-dismiss="modal">Confirmar</button>
        </div>
      </div>
    </div>
  </div>
      ...
      <form id="form-signature" action="/php/lock-sign.php" method="post" class="modal-content">
        ...
        <div class="modal-footer">
          <div style="position:absolute; padding:0px 20px 0px 0px;" "right">
            <input type="checkbox" id="confirm-lock" name="confirm-lock"> <label for="confirm-lock"> Acepto usar esta firma.</label>
          </div>
          <?php if ($signature) { ?>
          <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
          <?php } else { ?>
          <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
          <button id="confirm-signature-btn" type="submit" class="btn btn-primary" disabled>Confirmar</button>
          <?php } ?>
        </div>
      </div>
    </div>
        ...
        <div id="radionwallet">
          <div class="rw-unlock">
            ...
            <form action="#" method="get" id="rw-unlock-key">
              <div><strong>Dirección Pública:</strong> <span class="rw-unlock-pkh" style="color:#2980B9;"></span></div>
              <div class="form-group rw-hidden rw-unlock-key-input">
                <label for="rw-unlock-key-input">Frase de pase (Si es que alguna)</label>
                <input type="password" id="rw-unlock-key-input" class="form-control">
              </div>

              <div class="rw-hidden rw-unlock-error"></div>
              <button type="submit" class="btn btn-primary">Conectar</button>
              <button type="button" class="btn btn-danger rw-unlock-remove">Desconectar</button>
            </form>
          </div>
          ...
          <div class="rw-manage">
            ...
            <h2>Gestión de Llave</h2>
            <div>Balance: <span class="rw-manage-balance"></span> tez</div>
            <div>Direccion Publica: <span class="rw-manage-pkh"></span></div>
            <button type="button" class="btn btn-default rw-manage-lock">Cerrar con llave</button>
            <button type="button" class="btn btn-danger rw-manage-remove">Desconectar</button>
          </div>
          ...
          <div class="rw-connect">
            ...
            <h3 align="center">BILLETERA NATIVA</h3>
            <p align="justify" style="padding-bottom:20px;"><small><strong>Nota Importante</strong>:<br>La billetera nativa fue creada para cumplir con los requisitos elementales que necesita RADION para permitir la interacción con su plataforma. Esta característica está limitada a funciones específicas; consultar saldo y / o retirar fondos. Una vez que se familiarice con nuestro sistema, le recomendamos que migre a otro proveedor de billetera.</small></p>
            <form action="#" method="get" id="rw-connect-secret">
              <div class="form-group rw-connect-secret-input">
                <label for="rw-connect-secret-input">Llave Secreta / Encrypted Key / Palabras de semilla</label>
                <input type="text" id="rw-connect-secret-input" class="form-control">
              </div>

              <div class="form-group rw-hidden rw-connect-secret-pass-input">
                <label for="rw-connect-secret-pass-input">Palablra de pase (Si es que alguna)</label>
              ...
              <div class="form-group rw-hidden rw-connect-secret-email-input">
                <label for="rw-connect-secret-email-input">Correo Electronico (Si es que alguno)</label>
  ...
  <template id="rw-template-request">
    <form action="#" method="get" class="rw-request">
      <div>Destino <span class="rw-request-dest"></span></div>
      <div>Monto: <span class="rw-request-amount"></span></div>
      <button type="submit" class="btn btn-default">Aprovar</button>
      <button type="reset" class="btn btn-danger">Rechazar</button>
    </form>
  </template>
...
<li class="xn-openable">
            ...
            <div class="widget widget-primary widget-padding-sm">
              ...
              <div class="widget-buttons widget-c3">
                <div align="left" style="margin-top:0px; padding-left:15px;">
                  <a href="#" class="widget-control-right connect-wallet connect-wallet-text-connected" style="font-size:13px; text-decoration:none; color:#F39C12; display:none;"><i class="fad fa-wallet"></i> Desconectar Billetera</a>
                  <a href="#" class="widget-control-right connect-wallet connect-wallet-text-connect" style="font-size:13px; text-decoration:none; color:#F39C12;"><i class="fad fa-wallet"></i> Conectar Blletera</a>
                  <span class="connect-wallet-text-connect" style="padding-right:3px; padding-left:3px;">|</span>
                  <a href="#modal_basic" data-toggle="modal" class="connect-wallet-text-connect" style="font-size:13px; text-decoration:none; color:#F39C12;"><i class="fad fa-wallet"></i> Conectar Billetera Nativa</a>

                  <span class="connect-wallet-text-connected" style="padding-right:3px; padding-left:3px; display:none;">|</span>
                  <a href="#modal_small" data-toggle="modal" class="connect-wallet-text-connected" style="font-size:13px; text-decoration:none; color:#F39C12; display:none;"><i class="fad fa-qrcode"></i> Recibir</a>
                  <span class="connect-wallet-text-connected-radion" style="padding-right:3px; padding-left:3px; display:none;">|</span>
                  <a id="sidebar-toggler" href="#" class="sidebar-toggle connect-wallet-text-connected-radion" style="font-size:13px; text-decoration:none; color:#F39C12; display:none;"><i class="fad fa-paper-plane"></i> Retirar</a>
                ...
                <div id="slform_4">
                  <form action="" method="post" enctype="multipart/form-data" onSubmit="return slvalidateform_4(this)" style="padding:20px;">
                    ...
                    <div id="slfielddiv_4_10" class="sltextfield_4" style="padding-bottom:5px;">
                      <label for="slfieldinput_4_10">Autobiografía</label>
                    ...
                    <div id="slfielddiv_4_0" class="slfilefield_4" style="padding-bottom:5px;">
                      <label for="slfieldinput_4_0">Fotografía o Avatar<em>*</em></label>
                    ...
                    <div id="slfielddiv_4_1" class="sltextfield_4" style="padding-bottom:5px;">
                      <label for="slfieldinput_4_1">Nombre de Usuario</label>
                    ...
                    <div id="slfielddiv_4_10" class="sltextfield_4" style="padding-bottom:5px;">
                      <label for="slfieldinput_4_10">País / Estado or Ciudad</label>
                    ...
                    <div id="slfielddiv_4_2" class="sltextfield_4" style="padding-bottom:5px;">
                      <label for="slfieldinput_4_2">Fecha de Nacimiento</label>
                    ...
                    <div id="slfielddiv_4_3" class="sltextfield_4" style="padding-bottom:5px;">
                      <label for="slfieldinput_4_3">Número Telefónico</label>
                    ...
                    <div id="slfielddiv_4_4" class="sltextfield_4" style="padding-bottom:5px;">
                      <label for="slfieldinput_4_4">Sitio WEB</label>
                    ...
                    <div id="slfielddiv_4_6" class="sltextfield_4" style="padding-bottom:5px;">
                      <label for="slfieldinput_4_6">Canal YouTube URL</label>
                    ...
                    <button id="myButton_4" class="btn btn-warning btn-block" type="submit">ACTUALIZAR!</button><div id="slspinner_4"></div>
            ...
            <div class="panel panel-default" style="padding:40px;">
              ...
              <form action="#" class="form-horizontal">
                <div class="panel-body form-group-separated" style="padding-bottom:30px;">
                  ...
                  <div class="col-md-12"><div class="col-md-4"><strong>Nombre Legal:</strong></div><div class="col-md-8"><?= $slname ?></div></div>
                  <div class="col-md-12"><div class="col-md-4"><strong>Fecha de Nacimiento:</strong></div><div class="col-md-8"><?= $slcustom3 ?></div></div>
                  <div class="col-md-12"><div class="col-md-4"><strong>Domicilio:</strong></div><div class="col-md-8"><?= $slcustom9 ?></div></div>
                  <div class="col-md-12"><div class="col-md-4"><strong>Número de Teléfono:</strong></div><div class="col-md-8"><?= $slcustom4 ?></div></div>
                  <div class="col-md-12"><div class="col-md-4"><strong>Correo Electrónico:</strong></div><div class="col-md-8"><?= $slemail ?></div></div>
                  <div class="col-md-12"><div class="col-md-4"><strong>Billetera Crypto:</strong></div><div id="user-address" class="col-md-8 text-info"><?= $slcustom6 ?></div></div>
                </div>
              </form>
              <hr>
              <div style="padding:20px 0px 30px 0px;">
                <h3>CONFIGURACIÓN Y AJUSTES</h3>
                <div class="col-md-12"><small>Para un mejor nivel de protección en su cuenta, recomendamos una fuerte clave con más de doce caracteres, combinada con letras mayusculas y que active su 2FA.</small></div>
              </div>
              <hr>
              ...
              <div class="col-md-12">
                <div class="col-md-4">
                  ...
                  <div style="color:#ccc;"><small class="signature-status"><?= $signature ? 'Activated' : 'Necesita Aprobación!' ?></small></div>
                </div>
  ...
  <div class="sidebar">
    <div class="sidebar-wrapper scroll">
      <div class="sidebar-tabs">
        <a href="#sidebar_1" class="sidebar-tab active"><span class="fad fa-paper-plane"></span> RETIRAR</a>
      </div>

      <div class="sidebar-tab-content active" id="sidebar_1">
        <div class="content-frame-right" style="padding:20px;">

          <h2 align="center" style="color:#fff;"><strong>RETIRAR</strong></h2>
          <br>
          <div id="estimate-spinner" style="display:none;" align="center"></div>

          <form id="send-form" class="form-horizontal" role="form">
            <div style="padding-left:15px;"><span style="color:#fff;"><strong>BENEFICIARIO</strong></span><br><small style="color:#979A9A; margin-top:-5px;">Billetera donde enviar los fondos tez.</small></div>
            <div class="form-group">
              <div class="col-md-12">
            ...
            <div style="color:#fff; padding-left:15px;">MONTO</div>
            <div class="form-group">
              <div class="col-md-12">
            ...
            <div style="padding:15px;">
              <button class="btn btn-warning btn-block" id="send-submit">ENVIAR</button>
  ...
  $('#send-form').submit(async function (event) {
    ...
    try {
      if (radionTezos === null) {
        ...
        throw new Error('Favor de conectar su billetera primero antes de enviar.')
      }
  ...
  $('#send-confirm').click(async function (event) {
    ...
    try {
      ...
      const hash = op.hash
      noty({
        text: '<i class="fas fa-compact-disc fa-lg fa-spin"></i> Transacción fue enviada. Confirmando...<br>Favor de esperar confirmación! No actualice el navegador.<br><br><strong>Operación Hash:</strong><br> ' + hash.substr(0, 40) + '...',
        layout: 'topRight',
        type: 'information'
      })
