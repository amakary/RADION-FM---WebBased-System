...
<path style="fill:#3498DB;" d="M30.252 63.441c-4.55 0-7.864-1.089-9.946-3.267-2.08-2.177-3.121-4.525-3.121-7.041 0-.92.181-1.694.544-2.323a3.993 3.993
 ...
 4.646 0 3.098-.654 5.977-1.96 8.64-1.307 2.661-3.291 4.645-5.953 5.952-2.662 1.307-5.542 1.96-8.639 1.96z"></path>
					...
					<div style="padding-left:35px; margin-top:-20px;"><Strong>Recibe Tezos</strong></div>
					<br>
					<div align="jusity" style="padding-right:5px; padding-left:5px; font-size:9px; color:#515A5A;">
						<strong>Importante:</strong> Nosotros no guardamos las llaves de su billetera, conecte su billetera si quiere ver su codigo QR.</div>
					<hr>
						<div align="center" id ='qraddress'></div>
						<hr>
						<div style="padding-bottom:20px;">
					    <p style="color:#333; margin-bottom:-5px;"><strong>Billetera Publica:</strong></p>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="defModalHead" style="padding-left:20px;"><i class="fa fa-wallet"></i> CONECTAR BILLETERA</h3>
                    </div>
                    <div class="modal-body">
        ...
        <div class="modal" id="modal_basic_p" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span></button>
                        <h3 class="modal-title" id="defModalHead" style="padding-left:20px;"><i class="fa fa-shopping-cart"></i> ADQUIERE RADIO TOKENS</h3>
                    </div>
                    <div class="modal-body">
                    </div>
                    <div class="modal-footer">
                        ...
                        <div class="panel panel-primary animated zoomIn xn-drop-left xn-panel-dragging">
                            <div class="panel-heading">
                                ...
                                <div class="pull-right">
                                    <span class="label label-danger"><?php if (function_exists('sl_showprivatemessagecount')) { sl_showprivatemessagecount(); } ?> Nuevo</span>
                                </div>
                            </div>
          ...
          <div class="col-md-3">
            ...
            <div class="widget widget-primary widget-item-icon">
              <div class="widget-item-left">
                <img src="img/ON-logo-2.png" style="height:70%; width:70%;">
              </div>
              <div class="widget-data">
                <div class="widget-int num-count">RADIO</div>
                <div class="widget-title">BALANCE</div>
                <div class="widget-subtitle" id="radio-balance" style="color:#F39C12;">0 TOKEN</div>
              </div>
            </div>
            <!-- END WIDGET MESSAGES -->
          </div>
...
4.646 0 3.098-.654 5.977-1.96 8.64-1.307 2.661-3.291 4.645-5.953 5.952-2.662 1.307-5.542 1.96-8.639 1.96z"></path>
					...
					<!-- START WIZARD WITH VALIDATION -->
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <h3><i class="fad fa-edit fa-lg"></i> PUBLICIDAD</h3>
                    ...
                    <div class="wizard show-submit">
                      <ul>
                        <li>
                          <a href="#step-1">
                            ...
                            <span class="stepDesc"><i class="fad fa-drafting-compass"></i> Preparando<br><small>SU AD</small></span>
                          </a>
                        </li>
                        <li>
                          <a href="#step-2">
                            <span class="stepNumber">2</span>
                            <span class="stepDesc"><i class="fad fa-sliders-h-square"></i> Configurar<br><small>OPTIONES</small></span>
                          </a>
                        </li>
                        <li>
                          <a href="#step-3">
                            <span class="stepNumber">3</span>
                            <span class="stepDesc"><i class="fad fa-money-check-edit-alt"></i> Quota<br><small>IMPRECIONES</small></span>
                          </a>
                        </li>
                        <li>
                          <a href="#step-4">
                            <span class="stepNumber">4</span>
                            <span class="stepDesc"><i class="fad fa-paper-plane"></i> Enviar<br><small>AD</small></span>
                          </a>
                        </li>
                      </ul>
                      ...
                      <div id="step-1" class="wizard-step">
                        ...
                        <div class="form-group" data-step="2" data-intro="Your Ad's URL/link if you have one" data-position="bottom">
                          <label class="col-md-2 control-label">Enlace o URL</label>
                          <div class="col-md-10">
                            <input type="text" name="express_ads_website" id="express-ads-website" class="form-control" placeholder="Ejemplo: http://website.com/page">
                          </div>
                        </div>
                        ...
                        <h5><i class="fad fa-webcam fa-lg"></i> CONFIGURACIÓN AVANZADA</h5>
                        <p>(Optional)</p>
                        <div class="form-group">
                          <label class="col-md-2 control-label">Imagen</label>
                          <div class="col-md-10">
                            <label class="check"><input type="checkbox" class="icheckbox" id="need_image_upload"> Necesita subir imagen para su Ad?</label>
                            <span class="help-block">Solo para pagina principal.</span>
                          </div>
                        </div>

                        <div class="form-group">
                          <label class="col-md-2 control-label">Subir</label>
                          <div class="col-md-10">
                            <input type="file" class="fileinput btn-default" name="filename" id="filename" title="Buscar archivo">
                            <span class="help-block">Formato: JPG o PNG - (2048px x 750px)</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div id="step-2" class="wizard-step">
                        ...
                        <div class="col-md-6" data-step="5" data-intro="Your advertisement should be displayed here as a preview" data-position="left">
                          <h5><i class="fad fa-flask-potion fa-lg"></i> MUESTRAS</h5>
                          <div class="panel-body">
                            <div class="col-md-12" style="padding-bottom: 50px;">
                              <h5><strong>NOTA PEGAJOSA AD</strong> / Formato: <span style="color:#2980B9;">Texto</span> | Expuesto en: <span style="color:#2980B9;">Panel de control</span></h5>
                              <div class="alert alert-info" role="alert">
                                <span><i class="far fa-ad fa-lg"></i></span>
                                <span style="padding-right:20px;"></span>
                                <span id="message_visual"></span>
                                <a href="#" > con enlace</a>. <br>
                              </div>
                            </div>

                            <div class="messages messages-img">
                              <div class="item">
                                <h5><strong>MENSAJE AD</strong> / Formato: <span style="color:#2980B9;">Text</span> | Exposured on: <span style="color:#2980B9;">Pagina de Inicio</span></h5>
                                <div class="image">
                                  <img src="<?php siteloklink($slcustom2,0); ?>" alt="">
                                </div>
                                <div class="text">
                                  ...
                                  <p align="justify" style="padding:10px;">
                                    Este mensaje se mostrará en la página de inicio de RADIO. Este mensaje en particular no puede tener más de 500 caracteres.
                                  </p>
                                </div>
                              </div>
                            </div>
                      ...
                      <div id="step-3" class="wizard-step">
                        <div class="col-md-6" data-step="6" data-intro="Aqui puede colocar la cantidad que necesita" data-position="right">
                          <div class="panel-body" style="padding-bottom:50px; padding-top:30px;">
                            <div class="form-group">
                              <label class="col-md-3 control-label" style="color:#E0401D;">Impresiones</label>
                              <div style="width:100%; padding-left:20%; padding-right:20%;">
                                <div class="input-group">
                                  <span class="input-group-btn">
                                    <button class="btn btn-primary" type="button" onclick="set_min()">Minimo</button>
                                  </span>
                                  <input type="text" class="form-control" id="express-ads-impressions" placeholder="o Ingrese Cantidad">
                                  <span class="input-group-btn">
                                    <button class="btn btn-primary" type="button" onclick="set_max()">Maximo</button>
                                  </span>
                                </div>
                              </div>
                            </div><hr>
                            ...
                            <div class="form-group">
                              <label class="col-md-3 control-label">Hora Comienzo</label>
                              <div style="width:100%; padding-left:20%; padding-right:20%;">
                            ...
                            <div class="form-group">
                              <label class="col-md-3 control-label">Hora Termino</label>
                              <div style="width:100%; padding-left:20%; padding-right:20%;">
                                <div class="input-group bootstrap-timepicker">
                          ...
                          <div class="panel-body" style="padding-bottom:50px; padding-top:30px;">
                            <div align="center" style="padding-left:20%; padding-right:20%;">
                              <div class="widget widget-default">
                                ...
                                <div class="widget-subtitle"><span id="total_impression_">0</span> IMPRESIONES</div>
                                <div class="widget-subtitle"><span id="cost_for_imp_radio">XTZ: 0.00000000 </span></div>
                              </div>
                              <div>
                                <p style="color:#E0401D;" align="center">Nota Importante!</p>
                                <p align="justify">La quota es calculada en base a la informacion que usted provee.</p>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="table-invoice">
                            <table class="table">
                              <tr>
                                ...
                                <th class="text-center">Format0</th>
                                <th class="text-center">Total</th>
                              </tr>
                              <tr>
                                <td>
                                  <strong><span id="ad_title"> </span></strong>
                                  <p><span id="subtitle_id">Servicio seleccionado por el usuario va aqui.</span></p>
                                </td>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <table class="table table-striped">
                                ...
                                <tr>
                                  <td><strong>Tasa de conversión</strong></td><td class="text-right" id="total_radio_at_final">0</td>
                                </tr>
                                <tr class="total">
        ...
        <div class="sidebar">
            <div class="sidebar-wrapper scroll">
                ...
                <div class="sidebar-tabs">
                    <a href="#sidebar_1" class="sidebar-tab"><i class="fad fa-comments fa-lg"></i> TOKEN</a>
                    <a href="#sidebar_2" class="sidebar-tab"><i class="fal fa-newspaper fa-lg"></i> NOTICIAS</a>
                </div>
            ...
            <div class="mb-container">
                <div class="mb-middle">
                    ...
                    <div class="mb-content">
                        <p>Esta seguro que quiere cerrar esta sesión?</p>
  ...
  async function submitAllInformation () {
    ...
    $.ajax('/ad-submission_operation.php', {
      ...
      success: function (data) {
        ...
        if (result != 'Complete') {
          noty({
            text: 'Algo salio mal, trate nuevamente',
            layout: 'topRight',
            type: 'error'
          })
        } else {
          setTimeout(function () {
            noty({
              text: '<i class="far fa-check-circle fa-lg"></i> Todo listo, su publicidad esta publicada! Gracias.',
              layout: 'topRight',
              type: 'success'
            })
          }, 9000)
  ...
  async function makeTransaction () {
    ...
    if (!message) {
      noty({
        text: 'No tiene mensaje en su publicidad',
        layout: 'topRight',
        type: 'error',
        timeout: 5000
      })
    ...
    if (classes === 0) {
      noty({
        text: 'Seleccione un clase de ad',
        layout: 'topRight',
        type: 'error',
        timeout: 5000
      })
    ...
    try {
      ...
      noty({
        text: 'Transaccion fue rechazada',
        layout: 'topRight',
        type: 'error',
        timeout: 5000
      })
    ...
    noty({
      text: '<i class="far fa-satellite-dish fa-lg"></i> Transaccion fue enviada a blockchain. Favor de esperar confirmacion! No resetear su navergador.',
      layout: 'topRight',
      type: 'information',
      timeout: 8000,
      callback: {
        afterClose: function () {
          setTimeout(function () {
            noty({
              text: '<i class="fas fa-cog fa-spin fa-lg"></i> Magnifico, hemos comenzado el proceso, un momento.',
              layout: 'topRight',
              timeout: 5000
            })
          }, 20000)
    ...
    if (result.completed) {
      Swal.fire({
        ...
        title: 'EXITO',
        width: 450,
        html: '<br><p align="left" style="padding-left:10px;">TENEMOS CONFIRMACION!</p><hr><p align="left" style="padding-left:10px;"><strong>Transaccion ID:</strong></p><p align="left" style="font-size:13px; padding-left:10px;">' + hash + '</p>',
