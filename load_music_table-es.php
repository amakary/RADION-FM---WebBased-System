    ...
    <table style="width:100%;" class="datatable_simple">
      <thead>
        <tr style="border-bottom: 2px solid #dddddd;">
          ...
          <th style="width:30%; padding-bottom:10px;"> CANCION</th>
          <th style="width:30%; padding-bottom:10px;"> CARGADO POR</th>

          <th style="width:auto; padding-bottom:10px; padding-left:10px; padding-right:10px;"><i class="far fa-thumbs-up"></i></th>
          <th style="width:auto; padding-bottom:10px; padding-left:10px; padding-right:10px;"><i class="far fa-thumbs-down"></i></th>
          <th style="width:auto; padding-bottom:10px; padding-left:10px; padding-right:10px;"><i class="fas fa-heart"></i></th>

          <th style="width:auto; padding-bottom:10px; padding-left:10px; padding-right:10px;">INVERCIONISTA</th>

          <th style="width:30%; padding-bottom:10px; padding-left:10px; padding-right:10px;">POPULARIDAD</th>
...
<?php
  ...
  if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
      ...
      if ($isSongAvi < 1) {
        $purchase_btn='<button class="btn btn-default" onClick="notyConfirm()"><i class="fas fa-download"></i> COMPRAR</button>';
      } else {
        $have_download = 1;
  			$purchase_btn = '<button class="btn btn-default" onClick="purches_song()"><i class="fas fa-download"></i> DESCARGAR</button>';
      }
