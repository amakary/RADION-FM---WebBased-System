...
function forgotpw_11()
{
  ...
  if (sltrim_11(username.value)=="")
  {
     loginmessage.innerHTML='Forgot your password? Enter your username or email and the CAPTCHA and click the link';
    username.focus();
    return(false);
  }
            ...
            <div class="login-box animated fadeInDown">
               <div align="center" style="padding-bottom:20px;"><img src="img/logo@2x.png" style="height:45px; width:180px;"></div>
                ...
                <div class="login-body">
                    <div class="login-title" align="center" style="margin-bottom:-1px;"><strong>Welcome</strong>, Please login.</div>
...
<br>
<input type="text" class="form-control" name="username" id="slfieldinput_11_username" autocorrect="off" autocapitalize="off" spellcheck="off" maxlength="100" value="<?php print $slcookieusername; ?>" placeholder="Username"/>
</div>
<div class="sltextfield_11">
<br>
<input type="password" class="form-control" name="password" id="slfieldinput_11_password" autocorrect="off" autocapitalize="off" spellcheck="off" maxlength="50" value="<?php print $slcookiepassword; ?>" placeholder="Password"/>
</div>
...
<br>
<button class="btn btn-block btn-warning" id="myButton_11" type="submit">LOGIN</button><div id="slspinner_11"></div>
<br>
<a id="slforgot_11" title="Forgot your password? Enter your username or email and the CAPTCHA and click the link">Forgot Password?</a>
...
for (i = 0; i < timg.length; i++)
  timg[i].src = "/slpw/turingimage.php?t="+Math.floor(Date.now());
					...
					<div style="padding-bottom:10px; color:#fff; padding-right:30px;" align="right"><div align="left" style="color:#33414E; width:25px; height:25px;">
